...
void cUDP_Server::recov()
{
	try
	{
		...
		packedDecomposeByClient(remote_endpoint.port(), msg);
...
void		cUDP_Server::packedDecomposeByClient(int keyPortForMap, std::string packet)
{
	std::string m_CLEO_paket = packet;
